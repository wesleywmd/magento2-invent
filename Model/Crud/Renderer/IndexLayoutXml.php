...
class IndexLayoutXml extends AbstractXmlRenderer implements RendererInterface
{
    public function getPath(DataInterface $data)
    {
        $fileName = $data->getModuleName()->getSlug([strtolower($data->getModelName()), 'index']).'.xml';
