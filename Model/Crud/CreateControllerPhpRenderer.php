...
class CreateControllerPhpRenderer extends AbstractPhpRenderer implements PhpRendererInterface
{
    ...
    protected function getExecuteMethod(DataInterface $data)
    {
        ...
        return $this->phpBuilder->method('execute')
            ...
            ->addStmt($this->phpBuilder->methodCall($getTitleMethodCall, 'prepend', [
                $this->phpBuilder->funcCall('__', [$this->phpBuilder->val('Create New '.$data->getModel()->getClassName())])
            ]))
